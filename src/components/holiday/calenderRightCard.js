      ...
      <Box sx={style.holidayCardRight}>
        ...
        <Box sx={style.status}>
          ...
          <Typography variant="body1">
            No specific holidays observed. Standard weekend policy applies.
          </Typography>
        </Box>
        <Button
          sx={{
      ...
      <Box sx={style.hightlightsCard}>
        ...
        >
          ...
          >
            <Typography
              variant="h4"
              sx={{ fontSize: "12px", color: "#004CCA", fontWeight: "800" }}
            >
              03
            </Typography>
            <Typography
              variant="body1"
              sx={{ fontSize: "10px", color: "#004CCA", fontWeight: "800" }}
            >
              APR
            </Typography>
          </Box>
          <Box>
            <Typography
              variant="h4"
              sx={{ fontSize: "14px", color: "#181C1E", fontWeight: "800" }}
            >
              Good Friday
            </Typography>
            <Typography
              variant="body1"
              sx={{ fontSize: "12px", color: "#424656", fontWeight: "400" }}
            >
              Mandatory Holiday
            </Typography>
          </Box>
